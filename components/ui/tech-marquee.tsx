  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full gap-2 p-3">
        <div
          className={cn(
            'p-2 rounded-xl bg-gradient-to-br backdrop-blur-sm transition-all duration-300',
            skill.iconBox,
            skill.iconColor
          )}
        >
        ...
        <span className={cn('text-xs font-bold tracking-wide transition-colors duration-300', skill.text)}>
          {skill.name}
        </span>
      </div>
    </div>
...
export function TechMarquee() {
  ...
  return (
    <>
      ...
      <div className="relative w-full overflow-x-clip py-4">
        {/* Fade edges */}
        <div className="absolute left-0 top-0 bottom-0 w-16 z-10 bg-gradient-to-r from-zinc-950 to-transparent pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-16 z-10 bg-gradient-to-l from-zinc-950 to-transparent pointer-events-none" />
